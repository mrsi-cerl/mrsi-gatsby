        ...
        <div style={{ maxWidth: 700 }}>
          ...
          <ul>
            ...
            <li>
              ...
              authoring and reviews, contract awards, and delivery of
              facilities.
            </li>
            <li>
              Supports new acquisition strategies, one change in model updates
              all future RFPs.
            </li>
            <li>
              Criteria updates by USACE Centers of Standardization (COS), SRM
              and Operations and Maintenance (O&amp;M) subject matter experts
              ensure that new policy and best practices are quickly implemented
              in the field.
            </li>
          </ul>
          <p>
          ...
          <p>
            The Wizards provide standardization while letting users define
            project and facility specific Scopes of Work (SOW).
          </p>
        </div>
      </Layout>
    )
