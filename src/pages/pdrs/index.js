      ...
      <Layout hideSideNav path="/pdrs">
        <div style={{ maxWidth: 700, padding: 20 }}>
          ...
          <p>
            ...
            The PDR must be approved first before the ENG Form 3086 is
            submitted. Although ENG3086 status is also tracked in PDRS, it is
            not prepared in this system.
          </p>
          <p>
            This tool was developed by ERDEC-CERL at the request of HQ USACE. If
            you have questions about the software or the website, please email
            our <a href="mailto:MRSI_Support@usace.army.mil">support team</a>{" "}
            and we'll help you as soon as we're able.
          </p>
          <p>
            For PDR support, including access to projects, please contact either{" "}
            <a href="mailto:Donna.L.Thompson@usace.army.mil">Donna Thompson</a>{" "}
            or{" "}
