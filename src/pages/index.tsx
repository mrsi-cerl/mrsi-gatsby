...
const IndexPage = () => (
  <Layout title="Home" hideSideNav path="/" centerContent>
    ...
    <span className="font-sans-lg"><b>Current research initiatives</b> being investigated based on what 
      we have learned from the community through our tools include:</span>
    <CardGroup>
      <Card layout="flagDefault" headerFirst gridLayout={ { tablet: { col: 12 } } }>
          ...
          <CardBody>
            <p>
              ...
              research commenced on how to use this idea to meet the goals for the new tool.<br></br><br></br>
        ...
        <Card layout="flagDefault" headerFirst gridLayout={ { tablet: { col: 12 } } }>
          ...
          <CardBody>
            ...
            verified by an expert familiar with the product category.<br></br><br></br>
            ...
            agencies (GSA and EPA) as they are ahead of DoD using and analyzing EPDs.<br></br><br></br>
